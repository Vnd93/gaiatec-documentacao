---
id: gaiatec-indice-historico
titulo: Índice histórico
status: ativo
tipo: indice
area: historico
fase: transversal
...
Os nomes e as subpastas das evidências históricas foram preservados para manter rastreabilidade por
SHA. Esses arquivos não devem ser usados como descrição do estado operacional presente.
