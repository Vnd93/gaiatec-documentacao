...
- [ADR-016 — compatibilidade v1/v2 e command envelope](../../../20-arquitetura-seguranca/adr/ADR-016-compatibilidade-v1-v2-e-command-envelope.md)
- [ADR-017 — feature flags seguras](../../../20-arquitetura-seguranca/adr/ADR-017-feature-flags-seguras.md)
- [ADR-018 — release bundle e rollback](../../../20-arquitetura-seguranca/adr/ADR-018-release-bundle-e-rollback.md)
- [ADR-019 — rascunho, publicação e concorrência](../../../20-arquitetura-seguranca/adr/ADR-019-rascunho-publicacao-e-concorrencia.md)
- [ADR-020 — identidade PIM e proveniência](../../../20-arquitetura-seguranca/adr/ADR-020-identidade-pim-e-proveniencia.md)
