---
id: gaiatec-ev2-f16-evidencias-controles-2026-09-06
titulo: Evidências consolidadas dos controles de prontidão
status: ativo
tipo: evidencia-aditiva
...
substitui:
  - EVIDENCIAS_CONTROLES_2026-09-05.md
relacionados:
  - registro-declaracao-governanca-dpo-risco-2026-09-06.md
  - ../fase-12/registro-encerramento-g12-2026-09-06.md
---

# Evidências consolidadas dos controles de prontidão — 6 de setembro de 2026

> Sucessor aditivo baseado no blob CMS `faf20486da69cde96c7566d3096ad8788862a31c`, commit
> `123a15e6680e048dc29d176076149f01cf0830dc`. O registro
> [de 5 de setembro](EVIDENCIAS_CONTROLES_2026-09-05.md) permanece imutável.
>
> **Controle temporal:** os detalhes administrativos abaixo registram o estado declarado e
> observado no ciclo G16. Nesta reorganização, a API pública reconfirmou somente visibilidade,
> branch padrão e o indicador `protected` de `main`; faturamento e detalhes autenticados da regra
> não foram acessados. Proteção em repositório público também existe no GitHub Free, portanto ela
> não comprova, isoladamente, assinatura GitHub Pro.

## Verificações externas e configuração controlada

- o registro operacional de origem declarou GitHub Pro para `@Vnd93` e `main` protegida em
  `Vnd93/gaiatec-cms` com PR obrigatório, zero approvals, checks `quality`, `database` e `browser`,
  atualização estrita, conversas resolvidas, histórico linear, administradores incluídos, sem
  bypass, force-push ou exclusão;
...
[controle de aprovação do CMS](https://github.com/Vnd93/gaiatec-cms/blob/123a15e6680e048dc29d176076149f01cf0830dc/docs/ev2/fase-12/approvals/G12_e52b25d903251cf538918d89049a58524c3c9911.json),
validado pelo verificador local.
...
A evidência detalhada está no
[registro de produção G12](../fase-12/EVIDENCIAS_PRODUCAO_G12_2026-09-06.md).
