---
id: gaiatec-ev2-decisoes-acoes-necessarias
titulo: Decisoes e acoes necessarias para EV2
status: ativo
...
relacionados:
  - README.md
  - ESPECIFICACAO_TECNICA_FUNCIONAL_E_PLANO_DE_IMPLEMENTACAO.md
...
| EV2-D01 | Multisite será preparado na arquitetura e ativado somente em fase posterior, a partir da EV2.9 e após gates de isolamento.         | [ADR-015](../../20-arquitetura-seguranca/adr/ADR-015-multisite-preparado-e-ativacao-posterior.md) | Resolvido |
