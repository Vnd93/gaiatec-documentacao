...
- IA transacional: candidato local sintético implementado na EV2.14; permanece operacionalmente
  desabilitada até migration, gateway, avaliações, aprovação humana renovável, recuperação
  idempotente, compensação, kill switch e fallback manual passarem no Gate G14.
