---
id: gaiatec-auditoria-complemento-tecnico-operacional
titulo: Complemento técnico-operacional da auditoria e especificação do CMS GAIATEC
status: ativo
tipo: complemento-tecnico
...
substitui:
  - "gaiatec-cms:COMPLEMENTO_TECNICO_OPERACIONAL_AUDITORIA_CMS_GAIATEC.md"
relacionados:
  - indice.md
---
...
**Síntese:** a documentação inicial explica muito bem _o que_ a GAIATEC quer; faltava definir com precisão _como cada capacidade se conecta_, _quem pode executá-la_, _qual regra a valida_ e _como provar que funciona_.
